...
console.log("Pending Count:", pendingSwapsSnapshot.size);

pendingSwapsSnapshot.forEach((doc) => {
...
await setDoc(doc(db, "conversations", swapId), {
                      ...
                      <Link href={`/swaps/${swap.id}`} className="block hover:bg-gray-50">
                        <div className="px-4 py-4 sm:px-6">
                          ...
                          <div className="mt-2 sm:flex sm:justify-between">
                            <div className="sm:flex">
                              <p className="flex items-center text-sm text-gray-500">
                              Requested: {swap.createdAt?.toDate
                                 ? swap.createdAt.toDate().toLocaleDateString()
                                 : "N/A"}
                              </p>
                            </div>
                            {swap.receiverId === user?.uid && swap.status === "pending" && (
