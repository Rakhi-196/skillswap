    ...
    <DashboardLayout>
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <h1 className="text-2xl font-semibold text-gray-900">Active Swaps</h1>
        </div>
                        ...
                        <div className="px-4 py-4 sm:px-6">
                          ...
                          <div className="mt-2 sm:flex sm:justify-between">
                            <div className="sm:flex">
                              ...
                              Started:{" "}
                                {swap.startDate?.toDate
                              ? swap.startDate.toDate().toLocaleDateString()
                               : "N/A"}
                              </p>
                            </div>
