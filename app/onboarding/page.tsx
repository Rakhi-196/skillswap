      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 shadow sm:rounded-lg transition-colors duration-300">
          <div className="px-4 py-5 sm:p-6">
            ...
            {/* Progress bar */}
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5 mb-10">
              <div 
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <textarea
                      ...
                      name="bio"
                      rows={4}
                     className="shadow-sm focus:ring-primary-500 focus:border-primary-500 block w-full sm:text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400"
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Skills you can offer</h2>
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                      <input
                        ...
                        name="skill-offered"
                        id="skill-offered"
                       className="focus:ring-primary-500 focus:border-primary-500 flex-1 block w-full rounded-none rounded-l-md sm:text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                      ...
                      <button
                       ...
                       className="inline-flex items-center px-3 py-2 border border-l-0 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-white rounded-r-md hover:bg-gray-100 dark:hover:bg-gray-600 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                      >
                        Add
                      </button>
                    </div>
                ...
                {skillsOffered.length > 0 && (
                  <div className="mt-4">
                     <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Your skills:</h3>
                      ...
                      {skillsOffered.map((skill, index) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="ml-1.5 inline-flex items-center justify-center h-5 w-5 rounded-full bg-primary-200 dark:bg-primary-800 text-primary-500 dark:text-primary-200 hover:bg-primary-300 dark:hover:bg-primary-700 focus:outline-none"
                          >
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  <div className="sm:col-span-3">
                    <label htmlFor="skill-category" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                      Category
                    </label>
                    <select
                      id="skill-category"
                  ...
                  <div className="sm:col-span-3">
                    <label htmlFor="skill-wanted" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                      Skill
                    </label>
                    <div className="mt-1 flex rounded-md shadow-sm">
                      <input
                        ...
                        name="skill-wanted"
                        id="skill-wanted"
                       className="focus:ring-primary-500 focus:border-primary-500 flex-1 block w-full rounded-none rounded-l-md sm:text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400"
                      ...
                      <button
                        ...
                        className="inline-flex items-center px-3 py-2 border border-l-0 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-200 rounded-r-md hover:bg-gray-100 dark:hover:bg-gray-600 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                      >
                        Add
                      </button>
                    </div>
                ...
                {skillsWanted.length > 0 && (
                  <div className="mt-4">
                    <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Skills you want to learn:</h3>
                    <div className="mt-2 flex flex-wrap gap-2">
                      {skillsWanted.map((skill, index) => (
                        <span
                          key={index}
                          className="inline-flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-secondary-100 text-secondary-800 dark:bg-secondary-900 dark:text-secondary-200"
                        >
                          {skill}
                          <button
                            type="button"
                            onClick={() => handleRemoveSkillWanted(index)}
                            className="ml-1.5 inline-flex items-center justify-center h-5 w-5 rounded-full bg-secondary-200 dark:bg-secondary-800 text-secondary-500 dark:text-secondary-200 hover:bg-secondary-300 dark:hover:bg-secondary-700 focus:outline-none"
                          >
                            <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                            </svg>
